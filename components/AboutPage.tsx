...
export function AboutPage({ onPageChange }: AboutPageProps) {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setIsSticky(!(lastLineRect.top <= stickyTopPosition + tolerance));
    };
  ...
  const containerVariants = {
    ...
    visible: {
      opacity: 1,
      transition: { staggerChildren: 0.25, delayChildren: 0.15, ease: [0.16, 1, 0.3, 1] },
    },
  };
  ...
  const mobileContainerVariants = {
    ...
    visible: {
      opacity: 1,
      transition: { staggerChildren: 0.2, delayChildren: 0.1, ease: [0.16, 1, 0.3, 1] },
    },
  };

  const itemVariants = {
    hidden: { opacity: 0, filter: 'blur(18px) saturate(0.8)', y: 24, scale: 0.98 },
    visible: {
      opacity: 1,
  ...
  const simpleTextVariants = {
    hidden: { opacity: 0, y: 16, filter: 'blur(1px)', scale: 0.99 },
    visible: {
      opacity: 1,
      y: 0,
      filter: 'blur(0px)',
  ...
  const separatorVariants = {
    hidden: { opacity: 0, scaleX: 0, filter: 'blur(2px)' },
    visible: {
      opacity: 1,
      scaleX: 1,
      filter: 'blur(0px)',
  ...
  const sectionTitleVariants = {
    hidden: { opacity: 0, filter: 'blur(12px)', x: -16, scale: 0.95 },
    visible: {
      opacity: 1,
      filter: 'blur(0px)',
      x: 0,
  ...
  const contentVariants = {
    hidden: { opacity: 0, filter: 'blur(14px) saturate(0.9)', y: 18, scale: 0.97 },
    visible: {
      opacity: 1,
      filter: 'blur(0px) saturate(1)',
      y: 0,
  ...
  const CapabilityItem = ({
    ...
    return (
      <motion.div
        ...
        initial={false}
        style={{ height: '18px', marginBottom: '4px', display: 'flex', alignItems: 'center' }}
      >
        ...
        {isMobile && (
          <motion.span
            ...
            animate={{ opacity: isHovered ? 1 : 0, x: isHovered ? -20 : -12 }}
            transition={{ duration: 0.2, ease: 'easeOut' }}
            style={{ fontSize: '14px', lineHeight: '18px', height: '18px', display: 'flex', alignItems: 'center', right: '0px' }}
          >
            ←
          </motion.span>
        )}
        ...
        {!isMobile && (
          <motion.span
            ...
            animate={{ opacity: isHovered ? 1 : 0, x: isHovered ? -20 : -12 }}
            transition={{ duration: 0.2, ease: 'easeOut' }}
            style={{ fontSize: '14px', lineHeight: '18px', height: '18px', display: 'flex', alignItems: 'center' }}
          >
            ↳
          </motion.span>
        )}
        ...
        <motion.div
          ...
          transition={{ duration: 0.35, ease: [0.16, 1, 0.3, 1], x: { duration: 0.35 }, scale: { duration: 0.3 } }}
        >
          <p
        ...
        {/* Descripción inline - Solo desktop */}
        {!isMobile && (
          <motion.div
          ...
          >
            <p
              ...
              style={{ fontSize: '13px', lineHeight: '1.25', margin: '0', padding: '0' }}
            >
              {description}
            </p>
          </motion.div>
    ...
    <>
      ...
      <div className="md:hidden">
        <motion.div
          ...
          animate="visible"
        >
          <motion.div className="mb-12" variants={simpleTextVariants}>
          ...
          <motion.div variants={itemVariants}>
            ...
            >
              <p>
                Editado Studio is an editorial practice focused on publishing, research, and narrative design.
                We collaborate with media outlets, foundations, and independent creators to shape stories,
                aesthetics, and strategies with clarity and purpose.
              </p>
              <p>
                Our work spans building narrative frameworks, refining editorial voice, and prototyping content
                ecosystems that are culturally attuned and strategically grounded.
              </p>
            </motion.div>
          </motion.div>

          <motion.div className="w-full h-px bg-gray-300/80 my-8 origin-left" variants={separatorVariants} />
          ...
          <motion.div variants={itemVariants}>
            ...
            <motion.div className="font-sans text-sm" variants={contentVariants}>
              {capabilities.map((capability, index) => (
                <CapabilityItem key={capability} capability={capability} index={index} isMobile />
              ))}
            </motion.div>
          ...
          <motion.div variants={itemVariants}>
            ...
            >
              <p>
                Helping a leading crypto media outlet scale its editorial and distribution strategy across
                languages and markets.
              </p>
              <p>
                Ideating an alternative media outlet that covers Argentina&apos;s food system and maps local
                real-food brands.
              </p>
            </motion.div>
          </motion.div>
        ...
        <div className="px-3 md:px-6 lg:px-0 pt-32 lg:pt-40 pb-28 lg:pb-32 page-content-spacing">
          <div className="grid grid-cols-2 gap-6 md:gap-8 lg:gap-10 items-start">
            ...
            <div className="pr-6 md:pr-8 lg:pr-10">
              <div className="fixed-desktop-only" style={{ paddingTop: '0px' }}>
                <motion.h1
                  className="font-sans text-[36px] lg:text-[42px] xl:text-[48px] tracking-normal leading-[1.02] max-w-[98%]"
                  initial="hidden"
                  animate="visible"
                  variants={simpleTextVariants}
                  style={{ marginTop: '-8px', paddingTop: '0px' }}
                >
                  We shape stories and aesthetics as gestures of clarity and care.
                </motion.h1>
              </div>
            </div>
            ...
            <div className="scrollable-content-column">
              ...
              >
                ...
                <motion.div
                  ...
                  style={{ marginTop: '0px', paddingTop: '0px' }}
                >
                  <motion.div className="col-span-3 lg:col-span-3" variants={sectionTitleVariants}>
                  ...
                  >
                    <div className="space-y-5 text-content tracking-wide leading-tight font-sans">
                      <p>
                        Editado Studio is an editorial practice focused on publishing, research, and narrative
                        design. We collaborate with media outlets, foundations, and independent creators to
                        shape stories, aesthetics, and strategies with clarity and purpose.
                      </p>
                      <p>
                        Our work spans building narrative frameworks, refining editorial voice, and prototyping
                        content ecosystems that are culturally attuned and strategically grounded.
                      </p>
                      <p>
                        ...
                        , an entrepreneur and editor based in Buenos Aires with over a decade of experience in
                        international media, including CoinDesk, and cited by outlets such as the Financial
                        Times and El País.
                      </p>
                    </div>
                  </motion.div>
                ...
                <motion.div className="w-full h-px bg-gray-300/80 mb-4 origin-left" variants={separatorVariants} />

                {/* Capabilities */}
                <motion.div className="grid grid-cols-12 gap-2 lg:gap-3 items-start mb-12 lg:mb-16" variants={itemVariants}>
                  <motion.div className="col-span-3 lg:col-span-3" variants={sectionTitleVariants}>
                    <h2 className="text-footer tracking-wide leading-tight font-ibm-mono font-normal text-functional">
                      Capabilities
                    </h2>
                  </motion.div>
                  <motion.div className="col-start-4 col-span-9 lg:col-start-4 lg:col-span-9" variants={contentVariants}>
                ...
                {/* Currently */}
                <motion.div ref={currentlyRef} className="grid grid-cols-12 gap-2 lg:gap-3 items-start" variants={itemVariants}>
                  <motion.div className="col-span-3 lg:col-span-3" variants={sectionTitleVariants}>
                  ...
                  <motion.div className="col-start-4 col-span-9 lg:col-start-4 lg:col-span-9" variants={contentVariants}>
                    <div className="space-y-2.5 text-content tracking-wide leading-normal font-sans">
                      <p>
                        Helping a leading crypto media outlet scale its editorial and distribution strategy
                        across languages and markets.
                      </p>
                      <p ref={lastLineRef}>
                        Ideating an alternative media outlet that covers Argentina&apos;s food system and maps
                        local real-food brands.
                      </p>
                    </div>
                  </motion.div>
                </motion.div>
