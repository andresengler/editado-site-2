...
import { AboutPageNext } from '../../components/AboutPageNext';
...
export default function About() {
  ...
  // Use unified background for about page
  ...
  // Special layout for About - no overflow restrictions for sticky positioning
